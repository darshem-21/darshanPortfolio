...
const questLevels: QuestLevel[] = [
  ...
  },
  {
    ...
    themeName: "Agosphere & AI Lab",
    tagline: "Agosphere Marketplace & NLP Spam Detector",
    period: "2025 — 2026",
    sectionId: "projects",
    color: {
      bg: "bg-rose-500/20",
    ...
    stars: 3,
    xpUnlocked: ["Flutter Web (Agosphere)", "Supabase PostgreSQL Backend", "Geoapify Geocoding API", "TF-IDF & Scikit-Learn NLP (93.4% F1)"],
    loot: "Live Web & Mobile Ecosystem (errors-hack.github.io)",
    story: "Created impactful products including Agosphere (direct farm produce marketplace eliminating middlemen) and high-accuracy NLP fraud review classifiers.",
    icon: 'projects'
  },
  {
    id: 6,
